...
public class Main {
    public static void main(String[] args) {
        ...
        List<Blog> sampleBlog = new ArrayList<>(Arrays.asList(
                    new Blog(1L, Instant.parse("2023-11-16T08:14:17.00Z"), "Latifah", "Blog Title 1", "Sample Text 1"), 
                    new Blog(2L, Instant.parse("2023-11-16T08:10:57.00Z"), "Mojisola", "Blog Title 2", "Sample Text 2 with target"),
                    new Blog(3L, Instant.parse("2023-11-16T08:27:37.00Z"), "Salaudeen", "Blog Title 3", "Sample Text 3"),
                    new Blog(4L, Instant.parse("2023-11-16T08:27:11.00Z"), "NotLatifah", "Blog Title 4", "Sample Text 4 target"), 
                    new Blog(5L, Instant.parse("2023-11-16T05:40:31.00Z"), "NotMojisola", "Blog Title 5", "Sample Text 5 has target"),
                    new Blog(6L, Instant.parse("2023-11-16T08:10:57.00Z"), "NotSalaudeen", "Blog Title 6", "Sample Text 6")
                    ));
    ...
    // System.out.println(sampleBlog);
    Algorithm.mergeSortBlog(sampleBlog);
    System.out.println(sampleBlog);
    }
}
